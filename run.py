...
if __name__ == '__main__':
    ...
    if task == 'Polyps_CT':
        decode_record = generate_decode_function(args.record_shape, 'image', args.localisation)
        model = VGG
    elif task == 'Crohns_MRI':
        decode_record = generate_decode_function(args.record_shape, 'axial_t2', args.localisation)
        model = ResNet3D
