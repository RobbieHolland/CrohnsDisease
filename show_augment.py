...
train_data = '/vol/gpudata/rh2515/MRI_Crohns/tfrecords/ti_n80_k4/axial_t2_only_cropped_train_fold3.tfrecords'
test_data = '/vol/gpudata/rh2515/MRI_Crohns/tfrecords/ti_n80_k4/axial_t2_only_cropped_test_fold3.tfrecords'
feature_shape=(26,84,84)

# Dataset pipeline
decode_record = generate_decode_function(feature_shape, 'axial_t2')
pipeline = Pipeline(decode_record, train_data, test_data)
iterator, iterator_te = pipeline.create(volume_shape=feature_shape, batch_size=48, test_size=20)
features, labels = iterator_te.get_next()
